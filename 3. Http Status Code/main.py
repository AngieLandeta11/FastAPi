...
@app.get("/usersclass/",status_code=200)
async def usersclass():
    return (users_list)

@app.get("/usersclass/{id}",status_code=200) #Read
...
@app.post("/usersclass/",status_code=201) #Create
...
@app.put("/usersclass/",status_code=204) #Update
async def usersclass(user:User):
...
@app.delete("/usersclass/{id}",status_code=204) #Delete
async def usersclass(id:int):
